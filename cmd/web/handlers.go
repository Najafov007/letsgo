...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	requiredPath := app.sessionManager.PopString(r.Context(), "redirectPathAfterLogin")
	if requiredPath != "" {
		http.Redirect(w, r, requiredPath, http.StatusSeeOther)
		return
	}
...
func(app *application) accountPasswordUpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.MinChars(form.NewPassword, 8), "newPassword", "Password must have at least 8 characters")
